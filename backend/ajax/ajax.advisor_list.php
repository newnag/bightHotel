          ...
          //  echo $sql; 
            ...
            if ($result) {
                foreach ($result as $value) {
                    ...
                    $nestedData[] = date_format(date_create($value["date_receive"]), "d/m/Y - H:i");
                   ...
                   $columAction = '<div class="box-tools tdChild" style="text-align: center;">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm dropdown-toggle" data-toggle="dropdown">
                                            <i class="fa fa-bars"></i></button>
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            <li><a href="#" class="bt-view"   data-id="' . $value['id'] . '"  data-sales="' . $value['titleName'] . $value["name"] . '"><i class="fa  fa-eye  text-black"></i> ดูรายละเอียด</a></li>
                                            <li><a href="#" class="bt-view"   data-id="' . $value['id'] . '"  data-sales="' . $value['titleName'] . $value["name"] . '" ><i class="fa fa-file-text-o  text-green"></i> แบบตอบกลับ</a></li>
                                            <li><a href="#" class="bt-edit"   data-id="' . $value['id'] . '" ><i class="fa fa-pencil  text-aqua"></i> แก้ไขข้อมูล</a></li>';
                                            if ($_SESSION['role'] === 'superadmin' || $_SESSION['role'] === 'admin'){
                                               $columAction.=' <li><a href="#" class="bt-delete" data-id="' . $value['id'] . '"><i class="fa fa-remove  text-red"></i> ลบ</a></li>';
                                            }
                        $columAction .='</ul>
                                        </div>
                                    </div>';
                    $nestedData[] = $columAction;
                    $output[] = $nestedData;
                }
            }
