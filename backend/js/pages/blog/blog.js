...
$('#typeSpecial').on('click', function() {
    $(this).toggleClass('checked');
    $c = $(this).hasClass('checked') ? "special" : "";
    ...
    var new_url = decodeURIComponent(getQueryVariable(param[0], 'spc', $c));
    ChangeUrl($("#cate-id").val(), new_url);
})
