...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-newspaper-o"></i> ผลงาน<?php //echo $LANG_LABEL['content'];?> 
        ...
        <div class="box box-primary">
          ...
          <div class="categorybox-controls">
            ...
            <label class="">
              ...
              เลือกเฉพาะ ผลงานเด่นของเรา (หน้าเกี่ยวกับเรา) 
            </label>
            ...
            <div class="pull-right">
              <button type="button" class="btn btn-primary bt-add-content kt:btn-info" data-toggle="modal"><i class="fa fa-plus"></i> <?php echo "เพิ่มผลงาน";//$LANG_LABEL['addcontent'];?></button>
            </div>
            <?php
              }else {
            ?>
...
<?php
  include 'template/portfolio/addportfolio.php';
  include 'template/portfolio/editportfolio.php';
?>
<!-- css -->
...
<script src="<?php echo SITE_URL; ?>js/pages/portfolio/portfolio.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/portfolio/addportfolio.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/portfolio/editportfolio.js"></script>
