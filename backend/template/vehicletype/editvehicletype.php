<!-- Modal Edit Category -->      
<div id="modalEditCategory" class="modal fade blog-content blog-content-sm" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><i class="fa fa-pencil-square-o"></i> แก้ไขประเภท</h4>
      </div>
        ...
        <div class="row body-row-content">
          ...
          <div class="col-content col-md-12 scrollbar" id="scrollbar">
            <form id="form-edit-category">
              ...
              <input type="hidden" class="form-control" id="edit-title" name="edit-title">
              <input type="hidden" class="form-control" id="edit-keyword" name="edit-keyword">
              <input type="hidden" class="form-control" id="edit-description" name="edit-description">

              <div class="col-md-6">
                <div class="form-group">
                  <label>จำนวนที่นั่ง</label>
                  <input type="number" class="form-control" id="edit-seats" name="edit-seats" placeholder="Seats">
                </div> 
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="edit-doors" name="edit-doors" placeholder="Doors">
                </div> 
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="edit-airbags" name="edit-airbags" placeholder="Airbags">
                </div> 
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="edit-air" name="edit-air" placeholder="Air Conditioner">
                </div> 
              </div>
