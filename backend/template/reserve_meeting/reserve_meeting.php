<?php
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        <i class="fas fa-file-contract"></i> ติดต่อการจองห้องประชุม
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo SITE_URL; ?>"><i class="fa fa-dashboard"></i> <?php echo $LANG_LABEL['home'];//Home?></a></li>
        <li class="active">ติดต่อการจองห้องประชุม </li>
      </ol>
    </section>
  ...
  <script src="<?php echo SITE_URL; ?>js/pages/reserve/meeting.js?v=1.12"></script> 