<?php
  $category = $mydata->get_roomcategory();
  //print_r($category);
  $category_on_menu = $mydata->get_all_roomcategory($getpost, $_REQUEST['status']);
?>
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-tags"></i> หมวดหมู่ประเภทรถ
      <small>( <?php echo $language_name['display_name']; ?> )</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo SITE_URL; ?>"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
      <li class="active">หมวดหมู่ประเภทรถ</li>
    </ol>
  </section>
  ...
  <?php
    include 'template/car_cate/addcar_cate.php';
    include 'template/car_cate/editcar_cate.php';
  ?>
<!-- css -->
...
<script src="<?php echo SITE_URL; ?>js/pages/car_cate/car_cate.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/car_cate/addcar_cate.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/car_cate/editcar_cate.js"></script>