...
<script src="<?php echo SITE_URL; ?>js/pages/contentWeb/addcontent.js?v=<?=date('his')?> "></script>
<script src="<?php echo SITE_URL; ?>js/pages/contentWeb/editcontent.js?v=<?=date('his')?> "></script>
