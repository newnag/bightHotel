<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-user"></i> รายชื่อลูกค้าที่ซื้อ
        ...
        <div class="row">
            <div class=" col-xs-12 col-sm-12 col-md-11">
                <div class="box box-primary">
                    <div class="box-body">
                        <table id="buy-grid" class="table table-striped table-bordered table-hover no-footer" width="100%">
                            <thead>
                            <tr>
                                <th>วันที่</th>
                                <th>ชื่อลูกค้า</th>
...
<script src="<?php echo SITE_URL; ?>js/pages/car/buy_list.js?v=<?php echo date('ss');?>"></script>