...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-newspaper-o"></i> วิธีการชำระเงิน<?php //echo $LANG_LABEL['content'];?> 
        ...
        <div class="box box-primary">
          ...
          <div class="categorybox-controls">
            ...
            ?>
              ...
              <option value="18">วิธีการชำระเงิน</option>  
            ...
            <div class="pull-right">
              <!-- เพิ่มวิธีชำระเงิน-->
              <!-- <button type="button" class="btn btn-primary bt-add-content kt:btn-info" data-toggle="modal"><i class="fa fa-plus"></i> <?php echo "เพิ่มวิธีชำระเงิน";//$LANG_LABEL['addcontent'];?></button> -->
            </div>
            <?php
              }else {
            ?>
...
<?php
  include 'template/howtopay/addhowtopay.php';
  include 'template/howtopay/edithowtopay.php';
?>
<!-- css -->
...
<script src="<?php echo SITE_URL; ?>js/pages/howtopay/howtopay.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/howtopay/addhowtopay.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/howtopay/edithowtopay.js"></script>
