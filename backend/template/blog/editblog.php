        ...
        <div class="row body-row-content">
          ...
          <div class="col-content col-md-9 scrollbar" id="scrollbar-edit">
            ...
            <div class="col-md-4">
              ...
              <!-- <div class="col-md-4">
                <div class="form-group form-add-images">
                <label>รูปหน้าแรก</label>
                  <div id="image-preview">
                    <img id="blah-right-edit" src="#" alt="" />
                    <label for="image-upload" class="image-label">
                      <i class="fa fa-camera"></i>
                    </label>
                    <?php /* <div class="blog-preview-add"></div> */ ?>
              ...
              <!-- <div class="col-md-12">
                <div class="form-group form-add-slug">
                  <div class="input-group">
                  <label>ใครเห็นบทความนี้บ้าง</label>
                    <select name="edit-tech-status" class="form-control" id="edit-tech-status">
                      <option value="general">ทุกคน</option>
                      <option value="special">เฉพาะสมาชิกพิเศษ</option>
                    </select>
                  </div>     
                </div>
              </div> -->
