<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-bell" aria-hidden="true"></i>  การแจ้งเตือน (Notification)
    ...
    <div class="row"> 
      <div class="col-md-12">
        <div class="box box-primary"> 
          <div id="blog-payments" data-id="0"> 
         ...
         <form autocomplete="off" >
          <div class="box-body">
            <table id="notifypayments-grid" class="table table-striped table-bordered table-hover no-footer" width="100%">
              <thead>
                <tr>  
                  <th>Action</th> 
                  <th>Slip</th> 
...
<script src="<?php echo SITE_URL; ?>js/pages/notfication_payments/notify_payments.js?v=<?=date('his')?>"></script>