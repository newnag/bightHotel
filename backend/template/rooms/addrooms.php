<!-- Modal Add Content -->      
<div id="modalAddContent" class="modal fade blog-content blog-content-sm" role="dialog">
              ...
              <div class="col-md-12"> 
                <div class="blog-content-tag">
                  ...
                  <div class="box box-tag">
                    <div class="box-body">
                      <div class="form-group">
                        <input type="text" class="form-control" id="add-search-tag" name="add-search-tag" placeholder="ค้นหาสิ่งอำนวยความสะดวก">
                        <div class="sub-tag" id="add-searchtagresult"></div>
                      </div>

                      <div class="form-group">
                        <input type="text" class="form-control" id="add-tag" name="add-tag" placeholder="เพิ่มสิ่งอำนวยความสะดวก">
                      </div>
