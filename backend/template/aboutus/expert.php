...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-newspaper-o"></i> ผู้เชี่ยวชาญ<?php //echo $LANG_LABEL['content'];?> 
        ...
        <div class="box box-primary">
          ...
          <div class="categorybox-controls">
            ...
            ?>
              ...
              <option value="9">ผู้เชี่ยวชาญ</option>  
            ...
            <div class="pull-right">
              <button type="button" class="btn btn-primary bt-add-content kt:btn-info" data-toggle="modal"><i class="fa fa-plus"></i> <?php echo "เพิ่มผู้เชี่ยวชาญ" //$LANG_LABEL['addcontent']; ?></button>
            </div>
            <?php
              }else {
            ?>
...
<?php
  include 'template/aboutus/addexpert.php';
  include 'template/aboutus/editexpert.php';
?>
<!-- css -->
...
<script src="<?php echo SITE_URL; ?>js/pages/aboutus/expert.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/aboutus/addexpert.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/aboutus/editexpert.js"></script>
