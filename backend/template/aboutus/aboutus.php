...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-newspaper-o"></i> เกี่ยวกับเรา<?php //echo $LANG_LABEL['content'];?> 
            ...
            ?>
              <div class="attachment-block clearfix" <?php if ($post['display'] == 'no') {echo 'style="opacity: 0.6;"';} ?> >
                ...
                <div class="content-info">
                  ...
                  <p class="text-datetime"><i class="fa fa-clock-o" aria-hidden="true"></i> <?=date("d-m-Y H:i:s",strtotime($post['date_created']))?></p>
