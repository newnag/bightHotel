          ...
          <div class="col-content col-md-9 scrollbar" id="scrollbar-edit">
            <form id="form-edit-content">
              ...
              <div class="col-md-12">
                ...
                <label>ชื่อผู้เชี่ยวชาญ<?php //echo $LANG_LABEL['title'];?></label>
                  <input type="text" class="form-control" id="edit-title" name="edit-title" placeholder="ชื่อผู้เชี่ยวชาญ<?php //echo $LANG_LABEL['title'];?>" required>
                </div>
              </div>

              <div class="col-md-12">
                <div class="form-group">
                <label>ตำแหน่งงาน<?php //echo $LANG_LABEL['keyword'];?></label>
                  <input type="text" class="form-control" id="edit-keyword" name="edit-keyword" placeholder="ตำแหน่งงาน<?php //echo $LANG_LABEL['keyword']; ?>" required>
                </div>
              </div>

              <div class="col-md-12">
                <div class="form-group form-edit-description">
                <label>คำอธิบาย<?php //echo $LANG_LABEL['description'];?></label>
                  <input type="text" class="form-control" id="edit-description" name="edit-description" placeholder="คำอธิบาย<?php //echo $LANG_LABEL['description'];?>" required>
                </div> 
              </div>
