            ...
            <form id="form-add-content">
              ...
              <div class="col-md-12">
                <div class="form-group form-add-title">
                  ...
                  <input type="text" class="form-control" id="add-title" name="add-title" placeholder="ชื่อผู้เชี่ยวชาญ<?php //echo $LANG_LABEL['title'];?>" required>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="add-keyword" name="add-keyword" placeholder="ตำแหน่งงาน" required>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group form-add-description">
                  ...
                  <input type="text" class="form-control" id="add-description" name="add-description" placeholder="คำอธิบาย" required>
                </div> 
              </div>
