<?php
  $_SESSION['fix_cateid'] = '24';
  $getpost['cateid'] =  $_SESSION['fix_cateid'] ;
...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-newspaper-o"></i> แจ้งข่าวสาร<?php //echo $LANG_LABEL['content'];?> 
          ...
          <div class="categorybox-controls"> 
            <?php
             ...
             ?>
              ...
              <!-- <option value="7">เกี่ยวกับเรา</option>   -->
            ...
            ?>
              <div class="attachment-block clearfix" <?php if ($post['display'] == 'no') {echo 'style="opacity: 0.6;"';} ?> >
                ...
                <div class="content-info">
                  ...
                  <p class="text-datetime"><i class="fa fa-clock-o" aria-hidden="true"></i> <?=date("d-m-Y H:i:s",strtotime($post['date_edit']))?></p>
                  <p class="text-editor"><i class="fa fa-globe" aria-hidden="true"></i> <?php echo $post['lang_info']; ?>  <?php if($post['priority'] > 0){ ?>Priority : <?php echo $post['priority']?> <?php } ?>   </p>
                   <p class="text-editor">  <i class="fa fa-paper-plane"></i> สถานะ <?=($post['example'] == "send")?"<span>เคยส่งข้อความแล้ว</span>":"<span style='color:red; font-weight: bold;'>ยังไม่เคยส่งข้อความ</span>"?> </p>
                ...
                <div class="content-button pull-right">
                  ...
                  ?>
                     ...
                     <button type="button" class="btn btn-success margin-r-10 send-content kt:btn-success" data-id="<?php echo $post['id']; ?>" data-type="send"  style="padding: 8px 40px;">
                       <i class="fa fa-paper-plane"></i> ส่งข่าว
                     </button>
                     <?php
...
<?php
  include 'template/aboutus/addaboutus.php';
  include 'template/aboutus/editaboutus.php';
?>
<!-- css -->
...
<script src="<?php echo SITE_URL; ?>js/pages/aboutus/aboutus.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/aboutus/addaboutus.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/aboutus/editaboutus.js"></script>
<script src="<?php echo SITE_URL; ?>js/pages/transmit/transmit.js?v=<?=date('dhis')?>"></script> 
