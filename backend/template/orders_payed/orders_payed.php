        ...
        <div class="box box-primary">
          <div class="box-body">
            <table id="order-grid-table" class="table table-striped table-bordered table-hover no-footer" width="100%">
                <thead>
                  <tr>
                    <th style="text-align: center;">สลิปการโอน</th>
                    <th style="text-align: center;">รหัสการสั่งซื้อ</th>
                    <th style="text-align: center;">ชื่อลูกค้า</th>
                    <th style="text-align: center;">วันที่ชำระเงิน (ว/ด/ป)</th>
...
<?php
  include 'template/orders_payed/vieworder.php';
?>
<!-- css -->
...
<script src="<?php echo SITE_URL; ?>js/pages/orders_payed/orders_payed.js"></script>