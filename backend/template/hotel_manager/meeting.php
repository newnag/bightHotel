<?php
  ...
  $all_posts =  $mydata->get_product_meeting();   
?>
<style>
...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-newspaper-o"></i> จัดการห้องประชุม <?php //echo $LANG_LABEL['content'];?> 
      ...
      <section class="col-lg-12 connectedSortable">
        <div class="box box-primary">
          ...
          <div class="box-header" style="position: unset;">
            ...
            ?>
            <div><span class="btn-add"><button class="btn btn-info add-room-meeting">เพิ่มห้องประชุม</button></span></div>
            ...
            ?>
              <div class="attachment-block clearfix" <?php if ($post['display'] == 'no') {echo 'style="opacity: 0.6;"';} ?> >
                <div class="content-img">
                  <a class="fancybox" href="<?=ROOT_URL.$post['thumbnail']?>" title="<?=$post['title']?>">
                    <img src="<?=ROOT_URL.$post['thumbnail']?>" alt=""> 
                  </a>
                </div>
                <div class="content-info"> 
                  ...
                  <p class="text-datetime"> 
                    ...
                    <span style="color:#03a9f4;"> <?=(($post['display']=="yes")?"แสดงผล":"ไม่แสดงผล")?> </span>
                    <span style="color:#03a9f4;"> <?=$post['room_current_price']?>  </span> 
                  </p>
                  <p class="text-category"><?=$post['description']?>  </p> 

                  <!-- <p class="text-editor"><i class="fa fa-money" aria-hidden="true"></i> 
                    <span>ส่วนลดห้อง: <?=$post['discount']?></span>
                    </p> -->
                  <!-- <p class="text-editor"><i class="fas fa-user-plus"></i>  -->
                        <!-- <span>extra: <?=$post['room_extra']?> /คน</span> -->
                        <span style="color: #ffc41e;"><i class="fa fa-star"></i> Priority First</span> 
                    </p>
                </div>

                <div class="action-btn" style="text-align: end;">
                  <button type="button" class="btn btn-success margin-r-10 edit-product kt:btn-warning" data-id="<?php echo $post['id']; ?>"  style="padding: 8px 40px;">
                       <i class="fa fa-pencil-square-o"></i> <?php echo $LANG_LABEL['edit'];?>
                     </button>
                     <button type="button" class="btn btn-danger delete-product  kt:btn-danger" data-id="<?php echo $post['id']; ?>" style="padding: 8px 40px;"> 
...
<script src="<?php echo SITE_URL; ?>js/pages/hotel_manage/meeting.js?v=<?=date('ymdhis')?>"></script>
